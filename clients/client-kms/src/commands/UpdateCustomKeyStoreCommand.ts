 ...
 * // example id: to-edit-the-properties-of-a-custom-key-store-1628629851834
 * ```
 *
 ...
 * const command = new UpdateCustomKeyStoreCommand(input);
 * await client.send(command);
 * // example id: to-edit-the-friendly-name-of-a-custom-key-store-1630451340904
 * ```
 *
 ...
 * const command = new UpdateCustomKeyStoreCommand(input);
 * await client.send(command);
 * // example id: to-associate-the-custom-key-store-with-a-different-but-related-aws-cloudhsm-cluster-1630451842438
 * ```
 *
 */
